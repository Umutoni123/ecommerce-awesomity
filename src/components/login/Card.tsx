...
const Card = () => {
  return (
    <div className="lg:w-[400px] p-10 justify-between lg:bg-[#F4F5F6] flex flex-col">
      <Image src="/icons/logo.svg" alt="logo" width={56} height={56} />
      <div className="w-[118px] flex flex-col gap-4">
      ...
      <span className="font-dm-sans text-[12px] font-light leading-[24px] text-left">
